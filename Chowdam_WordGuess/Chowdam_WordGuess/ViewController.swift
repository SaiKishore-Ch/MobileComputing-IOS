...
class ViewController: UIViewController {
    ...
    var words = [["LINUX", "Operating System"],["MACBOOK", "Apple Device"],["JAVA", "Programming Language"],
                 ["DOG", "Most lovable Animal"],
                 ["EARTH","Our Planet in the Universe"]]
    var images = ["linux","macbook","java","dog","earth","tryAgain"]
